// Generated on 2014-02-16 using generator-angular 0.5.1
'use strict';
...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		watch : {
			...
			less : {
				files : ['Gruntfile.js', '<%= yeoman.app %>/styles/{,*/}*.less'],
				tasks : ['less']
			}
		},
		less : {
			development : {
				...
				files : {
					'<%= yeoman.app %>/styles/comprix.css' : '<%= yeoman.app %>/styles/main.less'
				}
			}
		},
		'concat_css' : {
	...
	grunt.registerTask('default', ['jshint', 'less', 'concat_css', 'test', 'watch']);
};